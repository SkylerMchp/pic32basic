# 1 "user.c"
# 1 "E:\\Modules\\4_Basic_Concurrency\\Demo4_Basic_Concurrency_Interrupts.X//"
# 1 "<command-line>"
# 1 "user.c"
...
# 528 "c:\\program files (x86)\\microchip\\xc32\\v1.42\\pic32mx\\include\\xc.h" 3
# 1 "c:\\program files (x86)\\microchip\\xc32\\v1.42\\pic32mx\\include\\proc\\p32mz2048ecg100.h" 1 3
# 38 "c:\\program files (x86)\\microchip\\xc32\\v1.42\\pic32mx\\include\\proc\\p32mz2048ecg100.h" 3
       
# 49 "c:\\program files (x86)\\microchip\\xc32\\v1.42\\pic32mx\\include\\proc\\p32mz2048ecg100.h" 3
...
# 529 "c:\\program files (x86)\\microchip\\xc32\\v1.42\\pic32mx\\include\\xc.h" 2 3
...
volatile int G_Allow_Lit_LEDs = 1;
volatile int G_LED_Scan_Delay = 10000000;
...
void __attribute__((vector(118), interrupt(IPL2SOFT), nomips16)) ISR_PortA_Change(void) {
    ...
    } else if (CNSTATAbits.CNSTATA5 == 1) {
        if (PORTAbits.RA5 == 1) {
            G_LED_Scan_Delay = 300000;
        } else {
            G_LED_Scan_Delay = 10000000;
        }
    }
