# 1 "main.c"
# 1 "E:\\待办事项\\完成石老师大学计划任务\\CML\\The-Connected-MCU-Lab--v1.5-12Oct2016-CHN\\Release\\Modules\\11_CPU\\Lab11_Cache_Solution//"
# 1 "<command-line>"
# 1 "main.c"
...
# 188 "c:\\program files\\microchip\\xc32\\v1.42\\pic32mx\\include\\math.h" 3
double acos (double);
double asin (double);
double atan (double);
double atan2 (double, double);
double ceil (double) __attribute__((__const));
double cos (double);
double cosh (double);
double exp (double);
double fabs (double) __attribute__((__const));
double floor (double) __attribute__((__const));
double fmod (double, double) __attribute__((__const));
...
long double ceill (long double x) __attribute__((__const));
long double cosl (long double x);
long double coshl (long double x);
long double expl (long double x);
long double fabsl (long double x) __attribute__((__const));
long double floorl (long double x) __attribute__((__const));
long double fmodl (long double, long double) __attribute__((__const));
...
double copysign (double, double) __attribute__((__const));
float copysignf (float, float) __attribute__((__const));
long double copysignl (long double, long double) __attribute__((__const));
...
float sqrtf (float);
float ceilf(float) __attribute__((__const));
float cosf(float);
float coshf(float);
float expf(float);
float fabsf(float) __attribute__((__const));
float floorf(float) __attribute__((__const));
float fmodf(float, float) __attribute__((__const));
...
__int32_t main(void) {
    ...
    while (1) {
        sprintf(buffer, "%u*%u array", (48), ((48)));
        OledSetCursor(0, 1);
        ...
        Pollute_Cache();
        t_test = Timed_Array_Test_CR((48), ((48)), aa, &sum);

        sprintf(buffer, "%6u T2 ticks", t_test);
        OledSetCursor(0, 2);
        OledPutString(buffer);

        sprintf(buffer, "%6.3f CPU cy/el", (4.0*t_test)/((48)*((48))));
        OledSetCursor(0, 3);
        OledPutString(buffer);
    }
}
