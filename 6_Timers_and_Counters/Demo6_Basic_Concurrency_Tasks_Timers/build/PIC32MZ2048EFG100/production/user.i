# 1 "user.c"
# 1 "E:\\Modules\\6_Timers_and_Counters\\Demo6_Basic_Concurrency_Tasks_Timers//"
# 1 "<command-line>"
# 1 "user.c"
...
# 12 "user.c" 2
# 1 "c:\\program files (x86)\\microchip\\xc32\\v1.42\\pic32mx\\include\\sys\\attribs.h" 1 3
# 48 "c:\\program files (x86)\\microchip\\xc32\\v1.42\\pic32mx\\include\\sys\\attribs.h" 3
...
volatile int Run_TASK_Scan_LEDs=0;



int G_Allow_Lit_LEDs = 1;
...
# 109 "user.c"
void __attribute__((vector(9), interrupt(IPL3SOFT), nomips16)) ISR_Timer_2_Scan_LED_FSM (void) {
    Run_TASK_Scan_LEDs++;
    IFS0bits.T2IF = 0;
}
...
void TASK_Scan_LEDs(void) {
    ...
    switch (FSM_state) {
    case 1:
        LATGbits.LATG6 = LED_state & G_Allow_Lit_LEDs;
        FSM_state++;
        break;
    case 2:
        LATDbits.LATD4 = LED_state & G_Allow_Lit_LEDs;
        FSM_state++;
        break;
    case 3:
        LATBbits.LATB11 = LED_state & G_Allow_Lit_LEDs;
        FSM_state++;
        break;
    case 4:
        LATGbits.LATG15 = LED_state & G_Allow_Lit_LEDs;
